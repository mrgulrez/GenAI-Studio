...
export default function ConversationPage() {
  ...
  const onSubmit = async (values: z.infer<typeof formSchema>) => {
    try {
      ...
      console.error("[LyricsPageError!] Error:", error);
    } finally {
      router.refresh();
    }
  };
  ...
  return (
    <div className="flex flex-col h-[calc(100vh-4rem)]">
      <Heading
        ...
        description="Our advanced AI-powered lyrics model"
      ...
      <div className="flex-grow p-4 lg:p-8 flex flex-col">
        <ScrollArea className="flex-grow mb-4 pr-4" ref={scrollAreaRef}>
          {messages.length === 0 && !isLoading ? (
            <Empty label="Generate your lyrics" />
          ) : (
                ...
                <FormItem className="col-span-12 lg:col-span-10">
                  <FormControl className="m-0 p-0">
                    <Textarea
                      ...
                      rows={1}
                      disabled={isLoading}
                      placeholder="Type your lyrics key points..."
                      {...field}
