...
export default function LandingPage() {
  return (
    <div className="min-h-screen bg-gray-100 flex flex-col items-center justify-center p-4 relative">
      ...
      <div className="mt-12 max-w-4xl text-center relative z-10">
        ...
        <div className="mt-8 bg-blue-100 p-4 rounded-lg text-blue-600 shadow-md transform transition-transform duration-300 hover:scale-105">
          <h3 className="text-lg font-medium">
            And much more to come! Stay tuned for new features and updates.
          </h3>
        </div>
      </div>
      ...
      {/* Footer Section */}
      <footer className="mt-16 text-gray-500 text-center relative z-10">
        © {new Date().getFullYear()} GenAI Studio. All rights reserved.
      </footer>
    </div>
  );
}
